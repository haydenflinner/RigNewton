// This is the sample code that outputs audio to a previously selected sound card.
//  Need to find a way to put cycle through a few frequencies, determine latency, then hook it up to RPM in sim 
//
...
int TargetFrequency = 125;
int TargetLatency = 10;
int TargetDurationInSec = 3;
bool ShowHelp;
